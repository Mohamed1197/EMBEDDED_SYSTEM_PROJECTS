...
#ifndef WRAPPER_W8TMR_TIMER0_INTERFACE_H_
#define WRAPPER_W8TMR_TIMER0_INTERFACE_H_
...
/*===========================================================================================================================*/
	 ...
	 *
	 * \b Description :
	 * This function for communication between application and Timer2 without destroying the layered architecture call back for CTC ISR
	 * @param   void (*Copy_pf)(void) pointer to function for the application function
	 * @return  u8 for error state
	 */
...
#endif /* WRAPPER_W8TMR_TIMER0_INTERFACE_H_ */
